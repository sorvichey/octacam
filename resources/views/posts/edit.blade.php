        ...
        <div class="col-lg-9 col-sm-9">
            <div class="card">
                <div class="card-header text-bold">
                    ...
                    <a href="{{url('/admin/post')}}" class="btn btn-link btn-sm">Back To List</a> &nbsp;&nbsp;|  &nbsp;&nbsp; <a href="{{url('/admin/post/create')}}" class="btn btn-link btn-sm">New</a>
                </div>
                    ...
                    <div class="card-block">
                        ...
                        <select name="sub_category" id="sub_category" class="form-control">
                            @foreach($sub_categories as $s)
                                <option value="{{$s->id}}" {{$s->id==$post->sub_category_id?'selected':''}}>{{$s->name}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
...
<script src="{{asset('js/select-sub-category.js')}}"></script>
