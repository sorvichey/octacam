                ...
                <div class="row">
                    <div class="col-12">
                        <div class="top-header-content d-flex align-items-center justify-content-between">
                            <div class="logo">
                                <a href="{{url('/')}}"><img src="{{asset('fronts/img/core-img/akp-english.png')}}" width="420" alt=""></a>
                            </div>
                    ...
                    <nav class="classy-navbar justify-content-between" id="newspaperNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    <li>
                                        <a href="{{url('/')}}" class="menu-2"><i class="fa fa-home"></i>
                                            Home
                                        </a>
                                    </li>
                                    @foreach($sub_menus as $sm) 
                                       <li>
                                           <a href="{{url('post/category/'.$sm->id)}}" class="menu-2">{{$sm->name}}</a>
                                       </li>
                                    @endforeach
                                </ul>
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <div class="footer-widget-area mt-30">
                            <div class="footer-logo">
                                <a href="{{url('/')}}"><img src="{{asset('fronts/img/core-img/akp-english.png')}}" width="400" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-1">
