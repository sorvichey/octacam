            ...
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('/admin/slide')}}"><i class="fa fa-slideshare text-warning"></i> Slide</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('/admin/qoute')}}"><i class="fa fa-quote-left text-success"></i> Qoute</a>
                            </li>
                            <li class="nav-item">
