...
<div class="featured-post-area">
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-8 col-lg-8 pd-0">
               <br>
                    ...
                    @foreach($posts as $p)
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 featured-image">
                                <a href="{{asset('kh/post/detail/'.$p->id)}}"><img src="{{asset('uploads/posts/small/'.$p->featured_image)}}" width="100%" alt=""></a>
                            </div>
                            @endif
                            @if($p->featured_image != null)
