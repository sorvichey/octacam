            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-3">
                    <div class="hero-add text-center">
                        <a href="#" class="text-white">  {{date('F')}} {{$day}},  {{$year}}</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-md-8 col-lg-8">
                    ...
                    @foreach($posts as $p)
                        <div class="single-blog-post small-featured-post shadow-sm p-3  bg-light rounded">
                            <div class="post-data">
                                <a href="{{url('post/detail/'.$p->id)}}" class="post-catagory">{{str_limit(strip_tags($p->title), $p->title = 225, $end = '...')}}</a>
                            </div>
                            <hr>
                            <div class="row">
                ...
                <div class="col-12 col-md-4 col-lg-4">
                        ...
                        <div class="single-blog-post small-featured-post d-flex">
                            <div class="col-md-12 px-0">
                                <a href="{{url('post/detail/'.$p->id)}}"><img src="{{asset('uploads/posts/small/'.$p->featured_image)}}" alt=""></a>
                                <div class="post-meta shadow-sm p-3  bg-light rounded">
                                    <a href="{{url('post/detail/'.$p->id)}}"  class="photo">
                         ...
                         @endforeach
                        <a class="btn btn-primary mt-3 mb-3"  href="{{url('post/category/11')}}"><i class="fa fa-arrow-right"></i> Read More </a>
