                                ...
                                <div class="col-md-6">
                                        <span>
                                            ...
                                            <ul class="rrssb-buttons">
                                                <a href="https://www.facebook.com/sharer/sharer.php?u={{url('fr/post/detail/'.$post->id)}}"  class="popup">
                                                    <span style="color:#4267b2;" class="fa fa-2x fa-facebook-official"></span>
                                                </a>
                                                <a href="https://twitter.com/intent/tweet?text={{$post->title}} {{url('fr/post/detail/'.$post->id)}}"
                                                class="popup">
                                                <span style="color:#00aced;" class="fa fa-2x text-info fa-twitter"></span>
                                                </a>
                                                <a href="mailto:?Subject={{$post->title}}&amp;body={{url('fr/post/detail/'.$post->id)}}">
