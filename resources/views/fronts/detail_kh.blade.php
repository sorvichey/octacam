        ...
        <div class="row">
            <div class="col-12 col-lg-8">
                <div class="blog-posts-area" style="background:#fff; padding: 0 15px; ">
                                ...
                                <div class="col-md-6">
                                        <span>
                                            ...
                                            <ul class="rrssb-buttons">
                                                <a href="https://www.facebook.com/sharer/sharer.php?u={{url('kh/post/detail/'.$post->id)}}"  class="popup">
                                                    <span style="color:#4267b2;" class="fa fa-2x fa-facebook-official"></span>
                                                </a>
                                                <a href="https://twitter.com/intent/tweet?text={{$post->title}} {{url('kh/post/detail/'.$post->id)}}"
                                                class="popup">
                                                <span style="color:#00aced;" class="fa fa-2x text-info fa-twitter"></span>
                                                </a>
                                                <a href="mailto:?Subject={{$post->title}}&amp;body={{url('kh/post/detail/'.$post->id)}}">
                    ...
                    <?php $lested_news = DB::table('posts')->where('category_id', 1)->where('active', 1)->orderBy('id', 'desc')->limit('5')->get(); ?>
                    ...
                    <div class="blog-sidebar-area">
                        ...
                        <div class="single-blog-post small-featured-post  shadow-sm bg-light rounded" style="padding: 10px 15px 1px 15px;">
                            <div class="title-news section-heading-kh">
                                ព័ត៌មានថ្មីបំផុត​
                            </div>
                            <hr class="hr1">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-4 padding-right-0 feature-image-smaller">
                                <a href="{{url('kh/post/detail/'.$n->id)}}"><img src="{{asset('uploads/posts/small/'.$n->featured_image)}}" alt=""></a>
                            </div>
                            @endif
                            @if($n->featured_image != null)
                            ...
                            @endif
                                <div class="post-data">
                                    <a href="{{url('kh/post/detail/'.$n->id)}}" class="post-catagory">{{str_limit(strip_tags($n->title), $n->title = 35, $end = '...')}}</a>
                                </div>
                            </div>
                            </div>
                        </div>  
